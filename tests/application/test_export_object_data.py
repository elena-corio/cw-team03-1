...
from application import export_object_data

def test_export_object_data_creates_json_file():
    # Set up dummy values
    export_object_data.PROJECT_ID = "dummy_project"
    export_object_data.OBJECT_ID = "dummy_object"
    export_object_data.OBJECT_DATA_FILE = "test_object_data.json"
    
    # Save output file in the test directory
    output_file = os.path.abspath("test_object_data.json")
    export_object_data.OBJECT_DATA_FILE = output_file
    ...
    export_object_data.get_client = Mock(return_value=mock_client)
    export_object_data.query_object_data_graphql = mock_query

    # Run the function
    export_object_data.export_object_data()
